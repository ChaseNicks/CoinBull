    ...
    <div className="container backgroundbull" style={{ marginTop: "2rem", width: "100%" }}>
      ...
      <div className="columns is-pricing" style={{ marginRight: ".2rem", marginLeft: ".2rem", marginTop: "2.5rem" }}>
        <div className="column is-half is-flex-direction-column is-align-items-center">
          ...
          <p style={{ marginTop: "1.3rem" }} className="is-size-5 is-size-6-mobile">Responsive charts that give you the power to make your best analysis from high level all the way to the lowest level on granularity </p>
      ...
      <div className="is-flex-direction-column is-justify-content-center is-align-content-center" style={{ marginRight: ".2rem", marginLeft: ".2rem", marginTop: "2.5rem" }}>
        ...
        <div className=" is-flex-direction-column is-align-items-center">
          ...
          <p style={{ marginTop: "1.3rem" }} className="is-size-5 is-size-6-mobile has-text-centered">A dynamic table with tons of cryptocurrencies has all the data you could ever need to make better buying and selling decisions. Filter and sort by the data points that will help you lock in your future for the digital world.</p>
      ...
      <div className="columns is-pricing" style={{ marginRight: ".2rem", marginLeft: ".2rem", marginTop: "2.5rem", marginBottom: "2.5rem" }}>
        <div className="column is-half is-flex-direction-column is-align-items-center">
          ...
          <p style={{ marginTop: "1.3rem" }} className="is-size-5 is-size-6-mobile"> Tracking a particular coin or maybe even multiple? Save it so you can view all your favorite coins on the same page with chart, pricing, percent change, and more.</p>
          <div className="is-flex is-justify-content-center">
      ...
      <div className="is-flex-direction-column is-justify-content-center is-align-content-center" style={{ marginRight: ".2rem", marginLeft: ".2rem", marginTop: "2.5rem", marginBottom: "2.5rem" }}>
        ...
        <div className=" is-flex-direction-column is-align-items-center">
          <h1 className="is-size-2 is-size-3-mobile  has-text-weight-medium has-text-centered">Always Know What's Being Talked About</h1>
          <p style={{ marginTop: "1.3rem" }} className="is-size-5 is-size-6-mobile has-text-centered">Constantly updating news feed so you'll always be on top of what's happening in the crypto world. Make better educated decisions based on what is being discussed in the media.</p>
